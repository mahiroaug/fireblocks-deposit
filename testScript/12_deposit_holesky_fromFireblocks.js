/*
 execute deposit-contract via web3provider(localhost) with direct private_key
  ...
  usage:   node testScript/02_deposit_holesky.js <deposit.json> [cumtom_amount]
  example: node testScript/02_deposit_holesky.js sampleData/deposit_data-1697983601.json 1
...
/*
 sendDeposit
  req   : json object
  payer : web3 object
  custom_amount : override deposit amount[ETH]
*/
